class SpaRouter { 
    static routeActive = {key: "#/home", value: "#"};
    static currentArgs = {}
    static ignoreNextCall = 0;
            ...
            if (this.routeActive.value !== routeNewObject) {
                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState === 4 && this.status === 200) {
                        ...
                        if (routeNewObject.func != null) routeNewObject.func.call();
                    }
                };
    //document.getElementById("slide-root").remove();
                ...
                if (routeNewObject.func != null) routeNewObject.func.call();
            } else console.log(Config.SPA.routerLoggingPrefix+"(🟠) Ignoring redundant page-switch to \""+window.location.hash.slice(1)+"\"");
        } else {
    ...
    static checkUrlHash() {
        ...
        if (this.ignoreNextCall <= 0) {
            ...
            else if (hash.slice(-1) == "/") { window.location.hash = hash.slice(0, -1); }
            else this.router(Config.SPA.routes[hash]);    
        } else { this.ignoreNextCall--; };
